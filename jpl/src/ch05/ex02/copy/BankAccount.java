...
// 191115 追記: next->deposit->next->depositになった場合の対処として
// 				add処理が10超えたときにでcurIdxを減算するように変更
	...
	public class History {
		...
		public void add(Action lastAct) {
			...
			if (length == historyLength+1) {
				...
				curIdx = Math.max(curIdx-1,0);// next->deposit->next->depositになった場合の対処
			}
		}
